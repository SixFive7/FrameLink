...
The workstation-side "Connection ... closed by remote host." message confirms the Pi actually went down rather than rejecting the `reboot` call. The Pi will be unreachable for roughly 30 seconds during the boot.
